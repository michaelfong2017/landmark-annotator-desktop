...
{
    DesktopApp* widget = new DesktopApp;
    ...
    //QString message = tr("Welcome to Wukong!");
    //statusBar()->showMessage(message);

    setWindowTitle(tr("Wukong"));
    widget->setMinimumSize(1285, 920);
    widget->resize(1285, 920);
}
//! [2]
...
void MainWindow::switchToSimplifiedChinese() {
...
{
    switchToEnglishAct = new QAction(tr("Switch to English"), this);
    connect(switchToEnglishAct, &QAction::triggered, this, &MainWindow::switchToEnglish);

    switchToSimplifiedChineseAct = new QAction(tr("Switch to Simplified Chinese"), this);
    connect(switchToSimplifiedChineseAct, &QAction::triggered, this, &MainWindow::switchToSimplifiedChinese);
...
void MainWindow::createMenus()
{
    ...
    languageMenu->addAction(switchToEnglishAct);
    languageMenu->addAction(switchToSimplifiedChineseAct);
//! [9] //! [10]
